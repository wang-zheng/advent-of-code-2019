...
def is_intersect(segment1,segment2):
    return max(segment1[0][0],segment1[1][0])>=min(segment2[0][0],segment2[1][0]) \
...
def min_distance_path(path1, path2):
    ...
    for i in range(len(path1)-1):
        for j in range(len(path2)-1):
            ...
            if is_intersect(segment1, segment2) and min_distance(segment1,segment2) < distance and min_distance(segment1,segment2) > 0:
...
def min_travel(segment1,segment2):
    ...
    return abs(segment1[0][0]-x_values[1]) + abs(segment1[0][1]-y_values[1]) \
    + abs(segment2[0][0]-x_values[1]) + abs(segment2[0][1]-y_values[1]) 
