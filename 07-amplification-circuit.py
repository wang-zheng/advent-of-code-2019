...
for permutation in list(perm):
    ...
    output,positionB = execute(programB,[permutation[1], output[0]],position=positionB)
    output,positionC = execute(programC,[permutation[2], output[0]],position=positionC)
    output,positionD = execute(programD,[permutation[3], output[0]],position=positionD)
    output,positionE = execute(programE,[permutation[4], output[0]],position=positionE)
